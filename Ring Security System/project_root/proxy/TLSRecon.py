...
def TLSType(datagram):
    ...
    try:
        ...
        for record in records:
            ...
            type_list.append((record_type,length))

    except Exception as inst:
        if type(inst) == dpkt.ssl.SSL3Exception:
            type_list.append((str(inst),len(datagram)))
        else:
...
def isTLSapp(datagram,logger):
    try:
        ...
        logger.debug("non TLS application")
    return False
